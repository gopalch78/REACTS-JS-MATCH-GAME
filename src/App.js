...
import MatchGameAppItem from './components/MatchGameAppItem'

import MatchGameTabItem from './components/MatchGameTabItem'

import MatchGameScoreCard from './components/MatchGameScoreCard'
...
class App extends Component {
  ...
  render() {
    const {activeTabId, score, time, isTimerRunning, Index} = this.state
